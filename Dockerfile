...
# SPDX-FileCopyrightText: 2026 The condition-gitea-actions Authors
...
LABEL org.opencontainers.image.title="semrel-plugin-condition-gitea-actions" \
      org.opencontainers.image.description="semrel plugin: condition-gitea-actions" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/condition-gitea-actions" \
